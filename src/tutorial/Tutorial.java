...
public class Tutorial extends JPanel {
	...
	public Tutorial() {
		...
		change_before= new ImageIcon(Tutorial.class.getResource("../image/change_before.png"));
		change_beforebtn=new JButton(change_before);
		...
		tutorial2=new JLabel("정해진 시간안에 틀린 곳을 찾으시오!");
		tutorial2.setBounds(400,550,1000,100);
		tutorial2.setFont(font);
		panel2.add(tutorial2);

		tutorial3=new JLabel("몇 개를 더 찾아야하는지 확인하시오!");
		tutorial3.setBounds(400,550,1000,100);
		tutorial3.setFont(font);
		panel3.add(tutorial3);

		tutorial4=new JLabel("<html>다른 부분이 아닌 곳을 건드리면 하트가 줄어듭니다!<br>&nbsp 하트가 모두 소진되면 게임종료!</html>");
		...
		panel1_next = new JButton(next_icon);
		...
		panel3_next=new JButton(next_icon);
